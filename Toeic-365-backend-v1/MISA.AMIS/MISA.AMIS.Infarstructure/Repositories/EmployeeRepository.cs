...
namespace TOE.TOEIC.Infrastructure
{
    ...
    public class EmployeeRepository : BaseRepository<Employee>, IEmployeeRepository
    {
        ...
        /// CREATED BY: DVHAI (07/07/2021)
        public IEnumerable<Employee> GetEmployeesFilterPaging(string filterValue, int? pageSize = null, int? pageNum = null)
        {
            //1. Ánh xạ giá trị
        ...
        public IEnumerable<ExportColumn> GetExportColumns()
        {
            //1. Tạo kết nối và truy vấn                        
            var exportColumns = _dbConnection.Query<ExportColumn>($"Proc_GetExportColumn", commandType: CommandType.StoredProcedure);
