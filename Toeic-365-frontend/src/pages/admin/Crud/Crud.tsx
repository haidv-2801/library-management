...
export const Crud = () => {
    ...
    const [deleteProductDialog, setDeleteProductDialog]: any = useState(false);
    const [deleteProductsDialog, setDeleteProductsDialog]: any = useState(false);
    const [product, setProduct]: any = useState(emptyProduct);
    ...
    const header = (
        <div className="table-header">
            ...
            <span className="p-input-icon-left">
                ...
                <InputText type="search" onInput={(e) => setGlobalFilter()} placeholder="Search..." />
            </span>
        </div>
    );
