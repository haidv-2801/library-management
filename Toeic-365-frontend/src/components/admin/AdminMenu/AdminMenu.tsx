            ...
            return (
                <li className={styleClass} key={i}>
                    ...
                    <CSSTransition classNames="p-toggleable-content" timeout={{ enter: 1000, exit: 450 }} in={active} unmountOnExit>
                        <AdminSubmenu items={item.items} onMenuItemClick={props.onMenuItemClick} />
                    </CSSTransition>
                </li>
            );
        });
...
export const AdminMenu = (props: any) => {
    return (
        <div className="layout-menu-container">
            <AdminSubmenu items={props.model} className="layout-menu" onMenuItemClick={props.onMenuItemClick} root={true} />
        </div>
    );
};
